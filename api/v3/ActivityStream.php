 ...
 */
function _civicrm_api3_activity_stream_create_spec(&$spec) {
  // $spec['some_parameter']['api.required'] = 1;
}

/**
 * ActivityStream.create API
 *
 * @param array $params
...
/**
 * ActivityStream.delete API
 *
 * @param array $params
 * @return array API result descriptor
 * @throws API_Exception
 */
function civicrm_api3_activity_stream_delete($params) {
